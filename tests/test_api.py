"""Tests for HeliosEasyControls3 api."""
import asyncio

import aiohttp
from custom_components.helioseasycontrols3.api import (
    Helioseasycontrols3ApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = Helioseasycontrols3ApiClient("test", "test", async_get_clientsession(hass))
